...
% 双面打印
%\documentclass[master, fontset=adobe, openany, twoside, zihao=-4]{sjtuthesis}
...
\usepackage{ccaption,setspace}
\usepackage{graphics}
\usepackage{graphicx}
\usepackage{multirow}
\usepackage{bm}
\usepackage{amsfonts}
%\usepackage[unsrt]{biblatex}
...
%% 参考资料
%\printbibliography
\printbibliography[heading=bibintoc,sorting = unsrt]
